<script>
  ...
  onMount(async () => {
    ...
    warp = window.warp.WarpFactory.custom(
      arweave,
      {
        inMemory: true,
      },
  ...
  async function createAsset() {
    try {
      ...
      log2("ERROR during creating atomic asset");
      log2(e.message);
    }
  }
  ...
  async function createSalesOrder() {
    try {
      ...
      log3("ERROR during creating Sales Order");
      log3(e.message);
    }
  }
  ...
  async function purchaseOrder() {
    try {
      ...
      log4("ERROR during purchasing atomic asset");
      log4(e.message);
    }
  }
...
<svelte:head>
  <script
    src="https://unpkg.com/warp-contracts@1.2.12/bundles/web.iife.bundle.min.js"></script>
</svelte:head>
...
<div class="mt-8 hero min-h-screen items-start">
  <div class="hero-content flex-col">
    <h1 class="text-4xl">Warp 1.2 Tradeable Atomic Asset Demo</h1>
    <div class="prose">
